...
If you're not sure how to do this, follow these instructions.There are other ways of achieving this, but this method will work for both Mac and Windows.
...
* It will start installing the package and produce a lot of text that might look like an error but isn't. If you get a message that says something like `package ‘tidyverse’ successfully unpacked and MD5 sums checked`, the installation was successful. If you get an error and the package wasn't installed, check the troubleshooting section of @sec-package-install-troubleshooting or come to office hours or a GTA session.

Now do the same but install a package named "cowsay".
