...
<div class='webex-radiogroup' id='radio_WMALJHXHTA'><label><input type="radio" autocomplete="off" name="radio_WMALJHXHTA" value=""></input> <span>Neuroticism</span></label><label><input type="radio" autocomplete="off" name="radio_WMALJHXHTA" value="answer"></input> <span>Conscientiousness</span></label><label><input type="radio" autocomplete="off" name="radio_WMALJHXHTA" value=""></input> <span>Extraversion</span></label><label><input type="radio" autocomplete="off" name="radio_WMALJHXHTA" value=""></input> <span>Agreeableness</span></label></div>
...
<div class='webex-radiogroup' id='radio_KAAAQSQDJS'><label><input type="radio" autocomplete="off" name="radio_KAAAQSQDJS" value=""></input> <span>Extraversion</span></label><label><input type="radio" autocomplete="off" name="radio_KAAAQSQDJS" value=""></input> <span>Conscientiousness</span></label><label><input type="radio" autocomplete="off" name="radio_KAAAQSQDJS" value=""></input> <span>Neuroticism</span></label><label><input type="radio" autocomplete="off" name="radio_KAAAQSQDJS" value="answer"></input> <span>Openness to Experience</span></label></div>
