...
<div class='webex-radiogroup' id='radio_AJVKZJGVQF'><label><input type="radio" autocomplete="off" name="radio_AJVKZJGVQF" value=""></input> <span>The tendency to be organized, careful, and disciplined</span></label><label><input type="radio" autocomplete="off" name="radio_AJVKZJGVQF" value="answer"></input> <span>The tendency to be compassionate, cooperative, and warm towards others</span></label><label><input type="radio" autocomplete="off" name="radio_AJVKZJGVQF" value=""></input> <span>The tendency to be outgoing, energetic, and sociable</span></label><label><input type="radio" autocomplete="off" name="radio_AJVKZJGVQF" value=""></input> <span>The tendency to experience mood swings, anxiety, and irritability.</span></label></div>
...
<div class='webex-radiogroup' id='radio_ECAMNEQHJY'><label><input type="radio" autocomplete="off" name="radio_ECAMNEQHJY" value=""></input> <span>Neuroticism</span></label><label><input type="radio" autocomplete="off" name="radio_ECAMNEQHJY" value="answer"></input> <span>Conscientiousness</span></label><label><input type="radio" autocomplete="off" name="radio_ECAMNEQHJY" value=""></input> <span>Extraversion</span></label><label><input type="radio" autocomplete="off" name="radio_ECAMNEQHJY" value=""></input> <span>Agreeableness</span></label></div>
...
<div class='webex-radiogroup' id='radio_OZVZBAJGJJ'><label><input type="radio" autocomplete="off" name="radio_OZVZBAJGJJ" value=""></input> <span>Extraversion</span></label><label><input type="radio" autocomplete="off" name="radio_OZVZBAJGJJ" value=""></input> <span>Conscientiousness</span></label><label><input type="radio" autocomplete="off" name="radio_OZVZBAJGJJ" value=""></input> <span>Neuroticism</span></label><label><input type="radio" autocomplete="off" name="radio_OZVZBAJGJJ" value="answer"></input> <span>Openness to Experience</span></label></div>
...
```
##  [1] 1 2 2 0 3 2 1 1 3 4 1 2 2 3 2 4 0 0 3 2
```
...
```
##  [1] 4 1 0 3 2 1 4 3 1 3 3 2 4 2 1 0 4 2 2 1 4 2 1 3 2 2 3 2 1 4 4 2 2 2 1 2 0 3
## [39] 2 2 1 3 2 2 1 3 2 3 2 3
```
